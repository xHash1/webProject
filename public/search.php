...
// print the selected limit data from database
                ...
                <div class="flex justify-center max-w-2xl my-9">
                    <div class="flex h-8 font-medium ">
                        <?php 
                            ...
                            echo '<a href="search.php?title='.$title.'&page='.$pagenum.'" class="w-8 md:flex justify-center items-center hidden cursor-pointer leading-5';
