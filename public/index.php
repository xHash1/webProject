                        ...
                        <div class="flex flex-col justify-between h-full">
                            ...
                            <div class="flex space-x-3 mb-10 text-sm font-medium justify-between">
                                ...
                                <div class="custom-number-input h-10 w-32 mb-4">
                                    ...
                                    <input name="amount" type="number" class="outline-none focus:outline-none text-center w-full bg-white border-gray-300 border font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700 outline-none" name="custom-input-number" value="1"></input>
