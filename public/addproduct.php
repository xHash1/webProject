            ...
            <main class=" max-w-screen-lg">
              ...
              <article aria-label="File Upload Modal" class="relative min-h-95 flex flex-col bg-white shadow rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
                <form action="add-product.php" method="POST" enctype="multipart/form-data">
                  <!-- overlay -->
                  <div id="overlay" class="w-full  absolute top-0 left-0 pointer-events-none z-50 flex flex-col items-center justify-center rounded-md">
                    <i>
                  ...
                  <div class="px-8 flex flex-col">
                    ...
                    <div class="flex relative">
                      <h1 class="flex-auto text-xl font-semibold m-2 pt-4">Add Product</h1>
                    ...
                    <div class="my-1">
                      ...
                      <textarea class="bg-white w-full h-28 p-1 px-4 rounded-md focus:border-gray-400 placeholder-gray-500 border-gray-200 focus:ring-1 focus:ring-gray-500 outline-none focus:bg-white border text-sm placeholder-opacity-100 text-black py-2 font-normal subpixel-antialiased" name="description" id="" cols="30" rows="10" required></textarea>
                    </div>
                    <div class="my-1">
                      <label for="">Price</label>
                      <input class="bg-white w-full p-1 px-4 rounded-md focus:border-gray-400 placeholder-gray-500 border-gray-200 focus:ring-1 focus:ring-gray-500 outline-none focus:bg-white border text-sm placeholder-opacity-100 text-black py-2 font-normal subpixel-antialiased" name="price" type="number" step="0.01" placeholder="0,00" required>
                    </div>
                  </div>

                  <!-- scroll area -->
                  <section class=" overflow-hidden p-8 flex flex-col pb-0">
                    <header class="border-dashed border-2 border-gray-400 py-8 flex flex-col justify-center items-center rounded-md">
                      <p class="mb-3 font-semibold text-gray-900 flex flex-wrap justify-center">
                        <span>Drag and drop your</span>&nbsp;<span>files anywhere or</span>
                      </p>
                      <input id="hidden-input" type="file" name="image" multiple class="hidden" required>
                      <button id="button" type="button" class="h-10 w-36 flex items-center justify-center rounded-md border border-gray-300 focus:outline-none hover:bg-gray-100 text-sm">
                        Upload a file
                      </button>
                    </header>
                    ...
                    <ul id="gallery" class="flex flex-1 flex-wrap -m-1">
                      <li id="empty" class="h-full w-full text-center flex flex-col justify-center items-center">
                        <img class="mx-auto w-32" src="images/upload.png" alt="no data" />
                  ...
                  <!-- sticky footer -->
                  <footer class="flex justify-end px-8  pt-4">
                    <button class="rounded-md px-8 py-2 text-black hover:bg-gray-100 focus:shadow-outline focus:outline-none border border-gray-300 text-sm" type="submit">
                      Add now
                    </button>
                    <button id="cancel" class="ml-3 px-8 py-2 rounded-md border border-gray-300 focus:outline-none hover:bg-gray-100 text-sm">
                      Cancel
                    </button>
                  </footer>
                </form>
